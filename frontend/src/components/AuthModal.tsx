...
import { X, Mail, BarChart3, Smartphone, LucideIcon } from "lucide-react";
import { API_URL } from "@/utils/ApiConfig";
import { signIn } from "next-auth/react";
import { useState } from "react";

const FeatureItem = ({ icon: Icon, title, desc }: { icon: LucideIcon, title: string, desc: string }) => (
  <div className="flex items-start gap-4 mb-4">
    <div className="bg-[#2a2c38] p-3 rounded-lg border border-gray-700">
        ...
        {!isEmailView ? (
          <>
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-black text-white mb-3">Eleve o Seu Jogo de Geografia</h2>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors"
              >
              ...
              <button
                ...
                className="w-full bg-white hover:bg-gray-200 text-black font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors"
              >
          ...
          <div className="w-full flex flex-col h-full justify-center">
            ...
            <div className="mt-6 text-center">
              <button onClick={() => setIsEmailView(false)} className="text-emerald-600/70 hover:text-white text-sm">
                &larr; Voltar
              </button>
            </div>
          </div>
